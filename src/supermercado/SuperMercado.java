...
public class SuperMercado {
    ...
    try {
        ...
        System.out.print("Seleccione una opcion: ");
        int tipoProd = Integer.parseInt(sc.nextLine());
        ...
        switch (tipoProd) {
            case 1: // FRITURA
                System.out.print("Ingrese Tipo de Fritura (ej. Papa, Totopo): ");
                String tipoF = sc.nextLine();
                System.out.print("Ingrese Sabor (ej. Adobada, Queso): ");
                String sabor = sc.nextLine();
                System.out.print("Ingrese Contenido en Gramos: ");
                double gramos = Double.parseDouble(sc.nextLine());
            ...
            case 2: // LACTEO
                System.out.print("Ingrese Tipo de Leche (ej. Entera, Deslactosada): ");
                String tipoL = sc.nextLine();
                System.out.print("Ingrese Fecha de Caducidad (AAAA-MM-DD): ");
                LocalDate fechaC = LocalDate.parse(sc.nextLine()); // Requiere formato estricto: 2026-05-25
                
                nuevoProducto = new Lacteo(precio, nombre, marca, "Lacteos", id, stock, 0, tipoL, fechaC);
                break;

            case 3: // QUESO (Hereda de Lacteo)
                System.out.print("Ingrese Tipo de Leche (ej. Vaca, Cabra): ");
                String tipoLecheQ = sc.nextLine();
                System.out.print("Ingrese Fecha de Caducidad (AAAA-MM-DD): ");
                LocalDate fechaCadQ = LocalDate.parse(sc.nextLine());
                System.out.print("Ingrese Tipo de Queso (ej. Oaxaca, Panela): ");
                String tipoQ = sc.nextLine();
                System.out.print("Ingrese Peso en Kg: ");
                double pesoQ = Double.parseDouble(sc.nextLine());
                System.out.print("¿Es importado? (true/false): ");
                boolean esImportado = Boolean.parseBoolean(sc.nextLine());
            ...
            case 4: // VERDURAS
                ...
                double pesoV = Double.parseDouble(sc.nextLine());
            ...
            if (nuevoProducto != null) {
                ...
                System.out.println("❌ Error: Formato de fecha invalido. Recuerde usar el formato AAAA-MM-DD (ej. 2026-07-05).");
            }
            break;
                case 2:
                    System.out.println("\n---------------------------------------------------------");
                    // CORRECCIÓN 1: Cambiado %-6s en vez de %-6d porque el ID es String
                    ...
                    case 3:
                        System.out.println("\n=== INICIAR NUEVA VENTA (CON OBJETO CAJA) ===");
                        ...
                        do {
                            ...
                            continuarCaja = sc.nextLine().trim().toLowerCase();
                ...
                case 5:
                    ...
                    String idBorrar = sc.nextLine().trim();
                    ...
                    for (int i = 0; i < inventario.size(); i++) {
                        if (inventario.get(i).getId().equalsIgnoreCase(idBorrar)) {
                            ...
                            System.out.println("🗑️ ¡Éxito! El producto '" + nombreEliminado + "' con ID [" + idBorrar + "] fue eliminado.");
